...
//     title:
//       'Website Audit & Optimization Dashboard – Taking Shape Interview Project',
//     description:
...
//     image: '/assets/audit-dashboard.png', // You'll need to add your project image
//   };
...
//           >
//             <div className='relative overflow-hidden rounded-xl shadow-2xl bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700'>
//               <Image
//                 src={project.image}
...
//                 priority={true}
//               />
//               <div className='absolute inset-0 bg-gradient-to-t from-black/30 via-transparent to-teal-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300' />
//               <div className='absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300'>
//                 <div className='bg-teal-500/20 backdrop-blur-sm border border-teal-400/30 rounded-full p-2'>
//                   <svg
...
//                 className='text-teal-400 font-mono text-sm uppercase tracking-wider font-semibold'
//               >
//                 {project.category}
//               </motion.p>
//               <motion.h3
...
//               className='relative'
//             >
//               <div className='absolute -left-4 top-0 w-1 h-full bg-gradient-to-b from-teal-400 to-teal-600 rounded-full opacity-60'></div>
//               <p className='text-gray-300 leading-relaxed text-base lg:text-lg pl-6'>
//                 {project.description}
//               </p>
//             </motion.div>
...
//               className='space-y-3'
//             >
//               <h4 className='text-slate-200 font-semibold text-sm uppercase tracking-wide'>
//                 Tech Stack
//               </h4>
...
//                     className='px-4 py-2 bg-gradient-to-r from-teal-500/20 to-teal-600/20 text-teal-300 rounded-lg text-sm font-mono border border-teal-500/30 hover:border-teal-400/50 transition-all duration-200 hover:shadow-lg hover:shadow-teal-500/20'
//                   >
//                     {tech}
//                   </motion.span>
//                 ))}
...
//                   whileTap={{ scale: 0.95 }}
//                   className='inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-teal-600 to-teal-700 hover:from-teal-500 hover:to-teal-600 text-white font-semibold rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl hover:shadow-teal-500/25 group'
//                 >
...
//           >
//             {/* Project Title Section Above Image */}
//             <div className='space-y-3'>
//               <motion.h3
//                 initial={{ opacity: 0, y: 20 }}
//                 whileInView={{ opacity: 1, y: 0 }}
...
//       whileInView='visible'
//       viewport={{ once: true, amount: 0.1 }}
//       className='relative py-20 lg:py-32 bg-gradient-to-br from-slate-900 via-slate-900 to-slate-800 overflow-hidden'
//       id='audit-project'
//     >
//       {/* Background Elements */}
...
//                     }}
//                     className='px-4 py-2.5 bg-gradient-to-r from-slate-800/80 to-slate-700/80 text-teal-300 rounded-xl text-sm font-mono border border-teal-500/30 hover:border-teal-400/60 transition-all duration-300 backdrop-blur-sm cursor-default'
//                   >
//                     {tech}
//                   </motion.span>
//                 ))}
